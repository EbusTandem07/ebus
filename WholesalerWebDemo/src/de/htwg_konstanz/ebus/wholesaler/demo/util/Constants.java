...
public class Constants {
    ...
    public static final String ACTION_SHOW_ORDER_CUSTOMER_RESPONSE_XML =
            "showOrderCustomerResponseXml";
    public static final String ACTION_SHOW_ORDER_PURCHASE_REQUEST_XML =
            "showOrderPurchaseRequestXml";
    public static final String ACTION_SHOW_ORDER_PURCHASE_RESPONSE_XML =
            "showOrderPurchaseResponseXml";
